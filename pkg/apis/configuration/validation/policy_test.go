			...
			policy: &v1.Policy{
				Spec: v1.PolicySpec{
					OIDC: &v1.OIDC{
						...
						UserInfoEndpoint:   "https://foo.bar/userinfo",
	...
	tests := []struct {
	...
	}{
		{
			oidc: &v1.OIDC{
				...
				UserInfoEndpoint:   "https://oauth2.googleapis.com/v1/userinfo",
		...
		},
		{
			oidc: &v1.OIDC{
				...
				JWKSURI:            "https://login.microsoftonline.com/dd-fff-eee-1234-9be/discovery/keys",
				ClientID:           "ff",
				ClientSecret:       "ff",
		...
		},
		{
			oidc: &v1.OIDC{
				...
				UserInfoEndpoint:   "http://keycloak.default.svc.cluster.local:8080/auth/realms/master/protocol/openid-connect/userinfo",
				EndSessionEndpoint: "http://keycloak.default.svc.cluster.local:8080/auth/realms/master/protocol/openid-connect/logout",
		...
		},
		{
			oidc: &v1.OIDC{
				...
				UserInfoEndpoint:   "http://127.0.0.1:8080/auth/realms/master/protocol/openid-connect/userinfo",
				EndSessionEndpoint: "http://127.0.0.1:8080/auth/realms/master/protocol/openid-connect/logout",
...
func TestValidateOIDCInvalid(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			msg: "missing required field userinfo endpoint",
		},
		{
			oidc: &v1.OIDC{
				AuthEndpoint:     "https://login.microsoftonline.com/dd-fff-eee-1234-9be/oauth2/v2.0/authorize",
			...
			msg: "missing required field end session endpoint",
		},
		{
			oidc: &v1.OIDC{
				AuthEndpoint:       "https://login.microsoftonline.com/dd-fff-eee-1234-9be/oauth2/v2.0/authorize",
		...
		},
		{
			oidc: &v1.OIDC{
				...
				UserInfoEndpoint:   "http://keycloak.default",
